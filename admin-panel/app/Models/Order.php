...
class Order extends Model {
    use LogsActivity;
    protected $fillable = ['order_number','user_id','status','subtotal','shipping_cost','discount_amount','total','payment_method_id','delivery_type_id','tracking_number','shipping_address_id','billing_address','promo_code','notes'];
    protected $casts = ['subtotal' => 'decimal:2','shipping_cost' => 'decimal:2','discount_amount' => 'decimal:2','total' => 'decimal:2','billing_address' => 'array'];
