...
export default function ProductDetailPageClient({
    ...
    slug: string;
    // Supplied by the server component so the product is in the initial HTML.
    // Absent only when the API was unreachable during SSR.
    ...
    const { product, isLoading: productLoading } = useProduct(slug, initialProduct);
