            ...
            const demoOrders: Order[] = [
                {
                    ...
                    items: [{ id: '1', quantity: 2, unitPrice: 44.95, product: mockProduct(1, 'vertuo-pop', 'Vertuo Pop', 'https://images.unsplash.com/photo-1517701550927-30cfcb64c54a?q=80&w=600', 99.00) }]
                },
                {
                    ...
                    items: [{ id: '2', quantity: 5, unitPrice: 9.00, product: mockProduct(2, 'lavazza-crema-aroma-expert-1kg', 'Lavazza Crema e Aroma Expert', 'https://images.unsplash.com/photo-1611162458324-aae1eb4129a4?q=80&w=600', 9.00) }]
                },
                {
                    ...
                    items: [{ id: '3', quantity: 1, unitPrice: 129.00, product: mockProduct(3, 'nespresso-essenza-mini', 'Nespresso Essenza Mini', 'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?q=80&w=600', 129.00) }]
                },
                {
                    ...
                    items: [
                        { id: '4', quantity: 2, unitPrice: 8.50, product: mockProduct(4, 'delta-cafes-intense', 'Delta Cafés Intense', 'https://images.unsplash.com/photo-1572119865084-43c285814d63?q=80&w=600', 8.50) },
                        { id: '4b', quantity: 1, unitPrice: 7.50, product: mockProduct(5, 'cafrezzo-dark-roast', 'Cafrezzo Dark Roast', 'https://images.unsplash.com/photo-1514432324607-a09d9b4aefdd?q=80&w=600', 7.50) }
                    ]
                },
                {
                    ...
                    items: [{ id: '5', quantity: 4, unitPrice: 16.95, product: mockProduct(6, 'lavazza-gran-espresso', 'Lavazza Gran Espresso', 'https://images.unsplash.com/photo-1442512595331-e89e73853f31?q=80&w=600', 16.95) }]
                },
                {
                    ...
                    items: [{ id: '6', quantity: 1, unitPrice: 199.00, product: mockProduct(7, 'delonghi-dedica', 'De\'Longhi Dedica', 'https://images.unsplash.com/photo-1509042239860-f550ce710b93?q=80&w=600', 199.00) }]
                },
                {
                    ...
                    items: [{ id: '7', quantity: 2, unitPrice: 17.50, product: mockProduct(8, 'lavazza-oro', 'Lavazza Qualità Oro', 'https://images.unsplash.com/photo-1507133750040-4a8f57021571?q=80&w=600', 17.50) }]
                },
                {
                    ...
                    items: [
                        { id: '8', quantity: 3, unitPrice: 9.50, product: mockProduct(9, 'nespresso-ristretto', 'Nespresso Ristretto', 'https://images.unsplash.com/photo-1534040385115-33dcb3acba5b?q=80&w=600', 9.50) },
                        { id: '8b', quantity: 2, unitPrice: 11.75, product: mockProduct(10, 'nespresso-lungo', 'Nespresso Lungo Leggero', 'https://images.unsplash.com/photo-1611162457474-631244a21754?q=80&w=600', 11.75) }
                    ]
                },
                {
                    ...
                    items: [{ id: '9', quantity: 1, unitPrice: 18.50, product: mockProduct(11, 'cafrezzo-mug-set', 'Cafrezzo Mug Set (x2)', 'https://images.unsplash.com/photo-1514228742587-6b1558fcca3d?q=80&w=600', 18.50) }]
                },
                {
                    ...
                    items: [
                        { id: '10', quantity: 6, unitPrice: 8.50, product: mockProduct(12, 'lavazza-espresso-italiano', 'Lavazza Espresso Italiano', 'https://images.unsplash.com/photo-1521302080334-4bebac2763a6?q=80&w=600', 8.50) },
                        { id: '10b', quantity: 1, unitPrice: 27.00, product: mockProduct(13, 'belgian-chocolate-box', 'Belgian Chocolate Box', 'https://images.unsplash.com/photo-1481391319762-47dff72954d9?q=80&w=600', 27.00) }
                    ]
                },
                {
                    ...
                    items: [{ id: '11', quantity: 1, unitPrice: 55.90, product: mockProduct(14, 'aeroccino-milk-frother', 'Aeroccino Milk Frother', 'https://images.unsplash.com/photo-1534040385115-33dcb3acba5b?q=80&w=600', 55.90) }]
                },
                {
                    ...
                    items: [{ id: '12', quantity: 4, unitPrice: 9.00, product: mockProduct(15, 'cafrezzo-arabica', 'Cafrezzo Pure Arabica', 'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?q=80&w=600', 9.00) }]
                },
                {
                    ...
                    items: [{ id: '13', quantity: 1, unitPrice: 249.00, product: mockProduct(16, 'jura-e4', 'Jura E4 Automatic', 'https://images.unsplash.com/photo-1517701550927-30cfcb64c54a?q=80&w=600', 249.00) }]
                },
                {
                    ...
                    items: [{ id: '14', quantity: 1, unitPrice: 14.90, product: mockProduct(17, 'cafrezzo-macarons', 'French Macarons Box', 'https://images.unsplash.com/photo-1558326567-98ae2405596b?q=80&w=600', 14.90) }]
                },
                {
                    ...
                    items: [
                        { id: '15', quantity: 1, unitPrice: 89.00, product: mockProduct(18, 'nespresso-inissia', 'Nespresso Inissia', 'https://images.unsplash.com/photo-1509042239860-f550ce710b93?q=80&w=600', 89.00) },
                        { id: '15b', quantity: 8, unitPrice: 9.25, product: mockProduct(19, 'lavazza-decaf', 'Lavazza Dek Decaf', 'https://images.unsplash.com/photo-1572119865084-43c285814d63?q=80&w=600', 9.25) }
                    ]
                },
                {
                    ...
                    items: [{ id: '16', quantity: 2, unitPrice: 14.90, product: mockProduct(20, 'glass-espresso-cups', 'Glass Espresso Cups (x4)', 'https://images.unsplash.com/photo-1514228742587-6b1558fcca3d?q=80&w=600', 14.90) }]
                },
                {
                    ...
                    items: [{ id: '17', quantity: 8, unitPrice: 12.00, product: mockProduct(21, 'cafrezzo-signature-blend', 'Cafrezzo Signature Blend', 'https://images.unsplash.com/photo-1442512595331-e89e73853f31?q=80&w=600', 12.00) }]
                },
                {
                    ...
                    items: [
                        { id: '18', quantity: 1, unitPrice: 22.00, product: mockProduct(22, 'coffee-cantucci', 'Cantucci Toscani', 'https://images.unsplash.com/photo-1481391319762-47dff72954d9?q=80&w=600', 22.00) },
                        { id: '18b', quantity: 1, unitPrice: 20.50, product: mockProduct(23, 'cafrezzo-gift-box', 'Cafrezzo Gift Box', 'https://images.unsplash.com/photo-1558326567-98ae2405596b?q=80&w=600', 20.50) }
                    ]
                },
                {
                    ...
                    items: [{ id: '19', quantity: 1, unitPrice: 179.00, product: mockProduct(24, 'krups-nespresso-citiz', 'Krups Nespresso Citiz', 'https://images.unsplash.com/photo-1459755486867-b55449bb39ff?q=80&w=600', 179.00) }]
                },
                {
                    ...
                    items: [{ id: '20', quantity: 3, unitPrice: 9.00, product: mockProduct(25, 'delta-cafes-classico', 'Delta Cafés Clássico', 'https://images.unsplash.com/photo-1521302080334-4bebac2763a6?q=80&w=600', 9.00) }]
                },
            ];
